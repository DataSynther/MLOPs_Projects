...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            #Read data from original data source
            df = pd.read_csv('notebook\data\stud.csv')
            logging.info('Original input dataset reading is successful!!')
...
if __name__=="__main__":
    ...
    train_arr, test_arr,obj_file = data_transformation.initiate_data_transformation(train_data, test_data)
